...
function startGame() {
  ...
  currentRomaji = wanakana.toRomaji(currentJapanese, { customKanaMapping });
...
function checkTyping() {
  ...
  const target = currentRomaji;

  if (wanakana.stripOkurigana(input) === wanakana.stripOkurigana(target)) {
...
// Optional: you could add custom kana mappings if needed
